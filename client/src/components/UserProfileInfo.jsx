...
const UserProfileInfo = ({ user,posts,UserProfileInfo,setShowEdite,profileId }) => {
  return (
    ...
    <div className='flex flex-col md:flex-row items-center gap-6'>
        ...
        {!profileId && 
        <button onClick={()=>setShowEdite(true)} className='flex items-center gap-2 border border-gray-300 hover:bg-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-color mt-4 md:mt-0 cursor-pointer'>
